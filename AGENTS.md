# NEON SERPENT — Codex Game Studios
...
@.Codex/docs/engine-reference (configure with `/setup-engine unity 2022.3`)
...
@.Codex/docs/agent-roster.md
@.Codex/docs/agent-coordination-map.md
